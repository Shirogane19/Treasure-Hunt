...
public class MiBusquedaFragment extends Fragment {
    ...
    private BusquedaFragment.OnFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof BusquedaFragment.OnFragmentInteractionListener) {
            mListener = (BusquedaFragment.OnFragmentInteractionListener) context;
        } else {
